...
function AIManagementLayout(){
 ...
 return <div className="ai-management-dashboard mx-auto grid w-full max-w-[1600px] gap-4 p-1 text-foreground">
  ...
  <label className="flex items-center gap-2 text-xs font-bold">
   Traffic data
   <select value={state.trafficMode} onChange={event => state.setTrafficMode(event.target.value as "auto" | "runtime" | "demo")} className="rounded border border-border bg-card p-2">
    <option value="auto">Automatic: real traffic, otherwise demo</option>
